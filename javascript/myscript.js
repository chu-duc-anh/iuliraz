...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Vợ iu Liraz đáng iu vcl :3   Số lần tương tư liraz--->" + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Ước gì ck có thể đáng iu hơn một chút:';
document.querySelector('.Description .modal-body').innerHTML = 'Vì ck muốn được lớp li :3333 <i class="fas fa-heart"></i> ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";

author.innerHTML = "Mún có tình iu của ck thì liên hệ<a href='https://www.facebook.com/buntom.0409/'>Đức Aanh<a>";
